...
struct nodo{
            ciudad Ciudad;//nombre del vertice o nodo
            struct nodo *sgte;
...
void menu()
{
    ...
    cout<<" 2. INSERTAR UN CAMINO NUEVO              "<<endl;
    cout<<" 3. ELIMINAR UNA CIUDAD                 "<<endl;
    cout<<" 4. ELIMINAR UN CAMINO              "<<endl;
    cout<<" 5. MOSTRAR  GRAFO                   "<<endl;
    cout<<" 6. MOSTRAR CAMINOS DE UNA CIUDAD       "<<endl;
    cout<<" 7. BUSQUEDA PROFUDA                           "<<endl;
    cout<<" 8. SALIR                            "<<endl;
            ...
            while(q!=NULL)
            {
                if(q->destino==aux2)
                {
                    if(q==aux->ady)
                        ...
                        r->sgte=q->sgte;
                    delete(q);
                    cout<<"ARISTA  "<<aux->Ciudad.nombre<<"----->"<<aux2->Ciudad.nombre<<" ELIMINADA.....!!!!";
                    return;
                }
            }
            r=q;
...
{   Tnodo ptr;
    ...
    while(ptr!=NULL)
    {   cout<<"   "<<ptr->Ciudad.nombre<<"|";
        if(ptr->ady!=NULL)
        {
            ar=ptr->ady;
            while(ar!=NULL)
            {   cout<<" "<<ar->destino->Ciudad.nombre;
                ar=ar->sgte;
             }
